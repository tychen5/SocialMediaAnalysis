...
# Set the path for the pickled classifiers
...
def main():
    ...
    classifier1, classifier2, classifier3, classifier4 = init_clfs()

    # Save the classifiers to a pickle file
    with open(models_path, 'wb') as file:
        pickle.dump(obj=(classifier1, classifier2, classifier3, classifier4), file=file)
